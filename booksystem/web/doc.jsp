      ...
      <div class="container-fluid">
        ...
        <div class="row col-12" style="padding-top:20px">
          ...
          <div class="col-2">
              ...
              <li class="list-group-item text-center"><a href="fdoclist.action">最新文档</a></li>
              <li class="list-group-item text-center"><a href="ftestlist.action">考试资料</a></li>
              <li class="list-group-item text-center"><a href="fexplist.action">实验报告</a></li>
              <li class="list-group-item text-center"><a href="fnoticelist.action">通知文档</a></li>
            </ol>
          </div>
          <div class="col-8">
                <table class="table">
