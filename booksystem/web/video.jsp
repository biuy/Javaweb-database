      ...
      <div class="container-fluid">
        ...
        <div class="row col-12" style="padding-top:20px">
          ...
          <div class="col-2">
              ...
              <li class="list-group-item text-center"><a href="fvideolist.action">最新视频</a></li>
              <li class="list-group-item text-center"><a href="fvideolist.action">其他</a></li>
            </ol>
          </div>
          <div class="col-8">
                <table class="table">
