        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <div class="input-group mb-3">
            <div class="input-group-prepend">
              <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">索书号</button>
              <div class="dropdown-menu" aria-labelledby="索书号">
                <a class="dropdown-item" href="author.jsp">作者</a>
                <a class="dropdown-item" href="publisher.jsp">出版社</a>
                <a class="dropdown-item" href="bookname.jsp">书名</a>
              </div>
            </div>
            <form class="form-inline" method="post" enctype="multipart/form-data" action="booknumber.action">
              <input type="text" name="booknumber" class="form-control" aria-label="Text input with dropdown button" placeholder="输入索书号">
